                              ...
                              <table id="example" class="display table table-striped table-hover table-bordered " style="width:100%">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                             ...
                                             ?></td>
                                             <td>
                                                  <a href="edit_employee.php?id=<?php echo $value['id'] ?>"> <img src="image/edit.png" style="height:40px;" alt=""> </a>
                                                  <a href="delete_employee.php?id=<?php echo $value['id']; ?>"> <img src="image/delete.png" style="height:40px;" alt=""> </a>
                                             </td>
                                        </tr>
                                        <?php
                                        }
